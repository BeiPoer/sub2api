...
curl -sSL https://raw.githubusercontent.com/BeiPoer/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
The compose files default to `ghcr.io/beipoer/sub2api:main`.
...
| `SUB2API_IMAGE` | No | `ghcr.io/beipoer/sub2api:main` | Docker image used by compose |
...
1. Download the latest release from [GitHub Releases](https://github.com/BeiPoer/sub2api/releases)
