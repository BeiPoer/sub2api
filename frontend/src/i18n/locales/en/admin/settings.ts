export default {
    settings: {
      ...
      site: {
        skin_agentory: "Agentory",
        skin_agentory_hint: "Inspired by Agentory: black and orange, orbital glow and rounded buttons. Dark captures the reference, with an adapted light mode.",
        skin_rescale: "Rescale",
        skin_rescale_hint: "Inspired by Rescale: blue, violet and cyan light, gradient headings, airy panels and pill buttons, with dark mode.",
        skin_outline: 'Outline',
        skin_outline_hint: 'Fine dividers, flat surfaces and quiet spacing for a document-like interface.',
        skin_instrument: 'Instrument',
        skin_instrument_hint: 'Instrument scales, monospace readouts and double dividers. Includes dark mode.',
        skin_folio: 'Folio',
        skin_folio_hint: 'A book-like work surface with serif headings and a contents sidebar. Includes dark mode.',
        skin_softblock: 'Softblock',
        skin_softblock_hint: 'Soft blocks, solid base shadows and pill buttons. Includes dark mode.',
        skin_bluehour: 'Blue Hour',
        skin_bluehour_hint: 'A blue sidebar paired with a light work surface. Includes dark mode.',
        skin_swiss: 'Index',
        skin_swiss_hint: 'Large headings, red markers and a strict grid. Includes dark mode.',
        skin_ribbon: 'Ribbon',
        skin_ribbon_hint: 'Accent ribbons and asymmetric corners. Includes dark mode.',
        skin_workspace: 'Workspace',
        skin_workspace_hint: 'Floating desktop sidebar and rounded work surfaces, with drawer navigation on mobile.',
        skin_press: 'Press',
        skin_press_hint: 'Bold outlines, offset solid shadows and tactile buttons, with light and dark modes.',
        skin_clear: "Clear Blue",
        skin_clear_hint: "A crisp blue and white interface with clear borders and light shadows, plus dark mode.",
        skin_aiwork: 'AIwork',
        skin_aiwork_hint: 'Inspired by AIwork: light gray grid, charcoal headings, luminous blue buttons and layered white panels, with dark mode.',
        skin_flexfolio: 'Flexfolio',
        skin_flexfolio_hint: 'Inspired by Flexfolio: soft gray, peach glow, orange pill buttons and fine dashed dividers, with dark mode.',
        skin_fantasy: "Fantasy",
        skin_fantasy_hint: "daisyUI light palette: white, purple, blue and orange. Includes an adapted dark mode.",
        skin_caramellatte: "Caramellatte",
        skin_caramellatte_hint: "daisyUI light palette: cream, caramel text and black buttons. Includes an adapted dark mode.",
        skin: "Site skin",
        skinHint: "Applies site-wide after saving. Visitors can still choose light or dark mode.",
        skin_default: "Original",
        skin_default_hint: "Teal gradients and glass cards. The familiar Sub2API look.",
        skin_editorial: "Editorial",
        skin_editorial_hint: "Warm paper, ink typography and vermilion accents, with a warm dark mode.",
        title: 'Site Settings',
