export default {
    settings: {
      ...
      site: {
        skin_agentory: "Agentory · 焰轨",
        skin_agentory_hint: "参考 Agentory：黑橙配色、轨道光晕与圆角按钮；深色呈现原作氛围，浅色为配套适配。",
        skin_rescale: "Rescale · 流光",
        skin_rescale_hint: "参考 Rescale：蓝紫青柔光、渐变标题、通透面板与胶囊按钮，配套深色模式。",
        skin_outline: '素线 · Outline',
        skin_outline_hint: '细线分区、平面卡片与克制留白，轻量文档式界面。',
        skin_instrument: '仪器 · Instrument',
        skin_instrument_hint: '刻度细节、等宽读数与双线栏头。配套深色模式。',
        skin_folio: '书页 · Folio',
        skin_folio_hint: '目录式侧栏、衬线标题与完整书页面板。配套深色模式。',
        skin_softblock: '柔块 · Softblock',
        skin_softblock_hint: '圆润积木、实体阴影与胶囊按钮。配套深色模式。',
        skin_bluehour: '蓝调 · Blue Hour',
        skin_bluehour_hint: '深蓝侧栏与浅色工作区，连贯的分区层次。配套深色模式。',
        skin_swiss: '索引 · Index',
        skin_swiss_hint: '大号标题、红线标记与严格网格。配套深色模式。',
        skin_ribbon: '缎带 · Ribbon',
        skin_ribbon_hint: '贯穿面板的色带与非对称圆角。配套深色模式。',
        skin_workspace: '浮岛 · Workspace',
        skin_workspace_hint: '独立悬浮侧栏、圆角工作面板与柔和层次，手机保留抽屉导航。',
        skin_press: '印刻 · Press',
        skin_press_hint: '清晰描边、硬边阴影、小圆角与按压反馈，配套深色模式。',
        skin_clear: "清蓝",
        skin_clear_hint: "清爽蓝白界面、明确边框与轻量阴影，配套深色模式。",
        skin_aiwork: 'AIwork · 智序',
        skin_aiwork_hint: '参考 AIwork：浅灰网格、炭灰大标题、蓝色微光按钮与叠层白色面板，配套深色模式。',
        skin_flexfolio: 'Flexfolio · 柔光',
        skin_flexfolio_hint: '参考 Flexfolio：浅灰底、桃粉柔光、橙色胶囊按钮与细虚线分隔，配套深色模式。',
        skin_fantasy: "Fantasy · 幻想",
        skin_fantasy_hint: "daisyUI 官方浅色：纯白底、紫色主色，搭配蓝色与橙色；含本站深色适配。",
        skin_caramellatte: "Caramellatte · 焦糖拿铁",
        skin_caramellatte_hint: "daisyUI 官方浅色：奶油底、焦糖棕文字、黑色主按钮；含本站深色适配。",
        skin: "站点皮肤",
        skinHint: "保存后对整个站点生效，访客仍可独立切换明暗模式。",
        skin_default: "原版",
        skin_default_hint: "青绿渐变与玻璃卡片，熟悉的 Sub2API 外观。",
        skin_editorial: "纸间 · Editorial",
        skin_editorial_hint: "暖白纸面、墨色排版与朱砂橙，配套暖黑夜间版。",
        title: '站点设置',
        description: '自定义站点品牌',
